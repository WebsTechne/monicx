...
\restrict bPhpbHWhXaZmik0D4Z3ncu4NOXflZ5zJjlpE6uNtr5YPOakUlFP5mtUqKNzMOxi
...
--
-- Name: OfferType; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: ProductColor; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."ProductColor" OWNER TO postgres;

--
-- Name: ProductSizeStock; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."ProductSizeStock" OWNER TO postgres;
...
cf9e797a-b9b2-4dc4-98c5-d0013b84432f	740a8a3fa11f71f573a9b1717e5a2c48df4a9e67d78ef3e74e591d939dd6249b	2025-10-09 23:05:14.469769+00	20250914180052_init_monicx	\N	\N	2025-10-09 23:05:13.920502+00	1
af390566-6976-4fea-964f-8a5881536668	e12c85f19b26c6938269b2dfc3755788f7483f22d2caa16ad0dd7d0289c1b8b5	2025-10-09 23:05:14.55891+00	20250921134646_add_slug_shortdes	\N	\N	2025-10-09 23:05:14.472179+00	1
a22440c8-edb9-4a49-86d0-b38067aa5a93	87535bfa654c9ead9ccab9799a8bd4d2a7c68f134631ffde45affc8c9dccbc07	2025-10-09 23:15:08.255984+00	20251009231507_add_category_image_path	\N	\N	2025-10-09 23:15:08.013303+00	1
e41bb6ef-63e1-4f1c-bdf9-323dc36e621f	7323a52a9f9f8cf15cb168db06ac00ff538a1e08bd5f13707a7da7172d37b0b5	2025-10-12 09:12:19.932227+00	20251012091219_mod_category_and_collection_slug	\N	\N	2025-10-12 09:12:19.873521+00	1
e70610d6-bc13-4512-ae95-ab95a44502b8	eac75270a2bb79bab96785b5b2f801ce3ba6ee1c35e0bf361512788f96ef21d0	2025-10-14 13:30:30.979124+00	20251014133030_mod_category_and_collection_optional_values	\N	\N	2025-10-14 13:30:30.954074+00	1
1a980f09-6788-4142-a275-c7f7c53ef611	7e26674c38fa4c4fb5dd7916786c88e581f4d331708d04ebfa8e426d5ed1f0f5	\N	20251207182758_add_nextauth_models	A migration failed to apply. New migrations cannot be applied before the error is recovered from. Read more about how to resolve migration issues in a production database: https://pris.ly/d/migrate-resolve\n\nMigration name: 20251207182758_add_nextauth_models\n\nDatabase error code: 42804\n\nDatabase error:\nERROR: foreign key constraint "Account_userId_fkey" cannot be implemented\nDETAIL: Key columns "userId" and "id" are of incompatible types: text and uuid.\n\nDbError { severity: "ERROR", parsed_severity: Some(Error), code: SqlState(E42804), message: "foreign key constraint \\"Account_userId_fkey\\" cannot be implemented", detail: Some("Key columns \\"userId\\" and \\"id\\" are of incompatible types: text and uuid."), hint: None, position: None, where_: None, schema: None, table: None, column: None, datatype: None, constraint: None, file: Some("tablecmds.c"), line: Some(9896), routine: Some("ATAddForeignKeyConstraint") }\n\n   0: sql_schema_connector::apply_migration::apply_script\n           with migration_name="20251207182758_add_nextauth_models"\n             at schema-engine\\connectors\\sql-schema-connector\\src\\apply_migration.rs:113\n   1: schema_commands::commands::apply_migrations::Applying migration\n           with migration_name="20251207182758_add_nextauth_models"\n             at schema-engine\\commands\\src\\commands\\apply_migrations.rs:95\n   2: schema_core::state::ApplyMigrations\n             at schema-engine\\core\\src\\state.rs:236	2025-12-07 18:33:21.336922+00	2025-12-07 18:28:01.064652+00	0
\.
...
--
-- Name: ProductColor ProductColor_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ProductSizeStock ProductSizeStock_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: Color_hexCode_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: ProductColor_colorId_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: ProductSizeStock_sizeId_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: ProductColor ProductColor_colorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ProductColor ProductColor_productId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ProductSizeStock ProductSizeStock_productId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ProductSizeStock ProductSizeStock_sizeId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: Product Product_collectionId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE "Color_id_seq"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "Offer"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE "Offer_id_seq"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public."Offer_id_seq" TO anon;
GRANT ALL ON SEQUENCE public."Offer_id_seq" TO authenticated;
GRANT ALL ON SEQUENCE public."Offer_id_seq" TO service_role;
...
--
-- Name: TABLE "ProductColor"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public."ProductColor" TO anon;
GRANT ALL ON TABLE public."ProductColor" TO authenticated;
GRANT ALL ON TABLE public."ProductColor" TO service_role;


--
-- Name: TABLE "ProductSizeStock"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public."ProductSizeStock" TO anon;
GRANT ALL ON TABLE public."ProductSizeStock" TO authenticated;
GRANT ALL ON TABLE public."ProductSizeStock" TO service_role;


--
-- Name: TABLE "ProductTag"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public."ProductTag" TO anon;
GRANT ALL ON TABLE public."ProductTag" TO authenticated;
GRANT ALL ON TABLE public."ProductTag" TO service_role;
...
--
-- Name: SEQUENCE "Size_id_seq"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public."Size_id_seq" TO anon;
GRANT ALL ON SEQUENCE public."Size_id_seq" TO authenticated;
GRANT ALL ON SEQUENCE public."Size_id_seq" TO service_role;
...
\unrestrict bPhpbHWhXaZmik0D4Z3ncu4NOXflZ5zJjlpE6uNtr5YPOakUlFP5mtUqKNzMOxi
