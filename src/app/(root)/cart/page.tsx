...
function CartPageContent() {
  ...
  return (
    <>
      <div className="flex-center flex flex-col gap-4">
        {/* TITLE */}
        <h1 className="text-2xl"> Your Shopping Cart</h1>
        {/* STEPS */}
        <div className="flex-center flex flex-row flex-wrap gap-7 lg:gap-10">
          {steps.map((s) => (
            <div
              className={cn(
            ...
            {activeStep === 1 ? (
              cart.length >= 1 ? (
                ...
                <p className="text-muted-foreground m-0!">
                  You haven&apos;t added any products to cart. Continue browsing
                  at the{" "}
                  <Link
                    href="/shop"
