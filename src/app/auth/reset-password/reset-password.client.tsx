        ...
        <div className="input-group">
          ...
          <div className="relative h-max w-full">
            <Input
              id="password"
              name="password"
              type={password.oldPassword.visible ? "text" : "password"}
              ...
              aria-invalid={!!error && !password.oldPassword.value}
            />
            <span
              role="button"
              tabIndex={0}
              aria-label={
                password.oldPassword.visible ? "Hide password" : "Show password"
              }
            ...
            <div id="oldPassword-desc" className="sr-only" aria-live="polite">
              {password.oldPassword.visible
                ? "Password is visible"
                : "Password is hidden"}
              .
        ...
        <div className="input-group">
          ...
          <div className="relative h-max w-full">
            <Input
              ...
              type={password.newPassword.visible ? "text" : "password"}
              ...
              aria-invalid={!!error && !password.newPassword.value}
            />
            <button
              type="button"
              aria-label={
                password.newPassword.visible ? "Hide password" : "Show password"
              }
            ...
            <div id="newPassword-desc" className="sr-only" aria-live="polite">
              {password.newPassword.visible
                ? "Password is visible"
                : "Password is hidden"}
              .
