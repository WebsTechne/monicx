...
import { Form } from "@/components/ui/form"; // <- added
...
export default function Page() {
    ...
    return (
        <div className="p-4.5 pt-7 pb-4">
            {/* pass the react-hook-form object so shadcn <Form> can do its thing */}
            <Form {...form}>
                <form
                ...
                >
                    ...
                    <div className="input-group">
                        ...
                        <div id="email-desc" className="sr-only">
                            We&apos;ll use this email to sign you in and for
                            account recovery.
                        </div>
                    </div>
                    ...
                    <div className="input-group">
                        ...
                        <div className="relative h-max w-full">
                            <Input
                                ...
                                name="password"
                                type={
                                    info.password.visible ? "text" : "password"
                                }
